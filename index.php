...
function cms_default_data(): array {
  return [
    ...
    'stats' => [
      ...
      'subtitle' => 'Small animated counters for trust, speed, and proof points.',
      'items' => [
        ['number' => '100%', 'label' => 'Flat-file JSON content'],
        ['number' => '1', 'label' => 'PHP application file'],
        ['number' => '0', 'label' => 'Database tables'],
        ['number' => 'SEO', 'label' => 'Clean URLs and meta controls'],
      ]
    ],
    'features' => [
      'enabled' => true,
      'title' => 'Built for fast landing pages',
      'subtitle' => 'Reusable editable feature rows with icons, text, and actions.',
      'image' => '',
      'items' => [
        ['title' => 'Visual inline editing', 'text' => 'Click headings, paragraphs, cards, and modal content directly on the page.', 'icon' => 'bi bi-magic'],
        ['title' => 'Product catalogue mode', 'text' => 'Run products like blog posts with modals, prices, discounts, galleries, buy links, and quote baskets.', 'icon' => 'bi bi-bag-check'],
        ['title' => 'Performance first', 'text' => 'Optional libraries, asset cache headers, compression rules, and JSON-only content keep the page lightweight.', 'icon' => 'bi bi-speedometer2'],
      ]
    ],
    'process' => [
      'enabled' => true,
      'title' => 'How it works',
      'subtitle' => 'A simple editable process timeline.',
      'items' => [
        ['title' => 'Upload', 'text' => 'Upload index.php and open the site once to create JSON and assets.', 'icon' => 'bi bi-cloud-arrow-up'],
        ['title' => 'Edit', 'text' => 'Login by email magic link and edit content inline or from the admin tabs.', 'icon' => 'bi bi-pencil-square'],
        ['title' => 'Publish', 'text' => 'Save JSON, sync .htaccess, and publish fast SEO-ready pages.', 'icon' => 'bi bi-rocket-takeoff'],
      ]
    ],
    'pricing' => [
      'enabled' => true,
      'title' => 'Pricing blocks',
      'subtitle' => 'Optional editable pricing cards for services, subscriptions, or packages.',
      'items' => [
        ['title' => 'Starter', 'price' => '€550', 'period' => 'one time', 'text' => 'Landing page setup with inline editing.', 'features' => ['One-page website', 'SEO basics', 'Contact form'], 'buttonText' => 'Request offer', 'buttonHref' => '#contact'],
        ['title' => 'Business', 'price' => '€990', 'period' => 'one time', 'text' => 'More sections, products, gallery, and quote flow.', 'features' => ['Product catalogue', 'Quote basket', 'Analytics/cookies'], 'buttonText' => 'Request offer', 'buttonHref' => '#contact'],
        ['title' => 'Custom', 'price' => 'Quote', 'period' => 'project', 'text' => 'Custom blocks, integrations, and design polish.', 'features' => ['Custom sections', 'Advanced forms', 'Theme tuning'], 'buttonText' => 'Add to quote', 'buttonHref' => '#products'],
      ]
    ],
    'faq' => [
      'enabled' => true,
      'title' => 'Frequently asked questions',
      'subtitle' => 'Bootstrap-style accordion content managed from JSON.',
      'items' => [
        ['question' => 'Can LPCMS run without a database?', 'answer' => 'Yes. Content, settings, SEO, products, redirects, and forms are stored in JSON.'],
        ['question' => 'Can products be quote-only?', 'answer' => 'Yes. Set product price to 0 and the buy button is hidden while Add to quote stays available.'],
        ['question' => 'Can I disable libraries?', 'answer' => 'Yes. Admin library settings let you connect or disconnect optional frontend libraries.'],
      ]
    ],
    'services' => [
      'enabled' => true,
    ...
    'products' => [
      'enabled' => true,
      'title' => 'Products',
      'subtitle' => 'Product catalogue cards with modal details, prices, discounts, gallery, buy and quote actions.',
      'mode' => 'catalog',
      'homeLimit' => 8,
      'batch' => 4,
      'desktopColumns' => 4,
      ...
      'buyButtonText' => 'Buy',
      'quoteButtonText' => 'Add to quote',
      'basketEnabled' => true,
      'basketTitle' => 'Quote basket',
      'basketButtonText' => 'Send quote request',
      'currency' => 'EUR',
      'items' => [
        [
          ...
          'body' => '<p>Perfect for a small business landing page. Includes a hero, about section, service cards, gallery, contact form, SEO settings, and JSON-powered content editing.</p>',
          'features' => ['One-page landing page', 'Inline editing', 'SEO-ready structure'],
          'buyUrl' => '#contact',
          'buyButton' => true,
          'quoteButton' => true,
          'related' => [],
        ...
        [
          ...
          'image' => '',
          'gallery' => [],
          'text' => 'A product or service package with price on request.',
          'body' => '<p>Use price 0 for products that should show only the Add to quote button. Visitors can collect products in the quote basket and send all selected items through the form textarea.</p>',
          'features' => ['Price on request', 'Quote basket support', 'Modal product details'],
          'buyUrl' => '',
          'buyButton' => false,
          'quoteButton' => true,
          'related' => [],
          'seo' => ['title' => 'Custom Quote Product', 'description' => 'Quote-only product page.', 'image' => '']
        ]
      ]
    ],
    'blog' => [
...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{margin:0;background:var(--cms-bg);color:var(--cms-text);font-family:var(--cms-font);font-size:16px;line-height:1.65;overflow-x:hidden;-webkit-font-smoothing:antialiased}
    a{color:inherit;text-decoration:none}.cms-soft{background:linear-gradient(180deg,var(--cms-soft),#fff)}.muted{color:var(--cms-muted)}
    h1,h2,h3,h4,h5,h6{letter-spacing:-.025em;color:#172033}.eyebrow{color:var(--cms-brand);font-weight:720;letter-spacing:.12em;text-transform:uppercase;font-size:.74rem}
    .site-header{position:sticky;top:0;z-index:50;background:rgba(255,255,255,.82);backdrop-filter:blur(18px);border-bottom:1px solid rgba(15,23,42,.07);box-shadow:0 10px 28px rgba(15,23,42,.035)}
    .brand-mark{display:flex;gap:.65rem;align-items:center;font-weight:740;font-size:1.05rem}.brand-mark img{max-height:40px;width:auto}.brand-dot{width:34px;height:34px;border-radius:11px;background:linear-gradient(135deg,var(--cms-brand),var(--cms-brand2));display:inline-flex;align-items:center;justify-content:center;color:#fff;font-weight:780;box-shadow:0 10px 22px rgba(13,110,253,.24)}
    .main-nav{display:flex;align-items:center;gap:.8rem}.main-nav ul{display:flex;align-items:center;gap:.2rem;list-style:none;margin:0;padding:0}.main-nav li{position:relative}.nav-linkx{display:inline-flex;align-items:center;padding:.62rem .82rem;border-radius:999px;color:#42526b;font-weight:620;font-size:.94rem}.nav-linkx:hover{background:rgba(13,110,253,.075);color:var(--cms-brand)}.submenu{display:none!important;position:absolute;left:0;top:100%;background:#fff;box-shadow:0 22px 70px rgba(15,23,42,.12);border:1px solid rgba(15,23,42,.08);min-width:220px;border-radius:18px;padding:.5rem!important}.has-sub:hover>.submenu{display:block!important}.submenu li,.submenu a{width:100%}.nav-actions{display:flex;align-items:center;gap:.5rem}.icon-btn{border:1px solid rgba(15,23,42,.08);background:#fff;border-radius:999px;width:40px;height:40px;display:inline-flex;align-items:center;justify-content:center;color:#40516b;box-shadow:0 8px 22px rgba(15,23,42,.04);transition:.18s ease}.icon-btn:hover{transform:translateY(-1px);color:var(--cms-brand)}.hamburger{display:none}.mobile-panel{display:none}
    ...
    .btn-cms{display:inline-flex;align-items:center;justify-content:center;gap:.5rem;border:0;border-radius:999px;padding:.78rem 1.15rem;background:linear-gradient(135deg,var(--cms-brand),var(--cms-brand2));color:#fff;font-weight:700;box-shadow:0 14px 34px rgba(13,110,253,.21);transition:.18s ease}.btn-cms:hover{color:#fff;transform:translateY(-2px);box-shadow:0 18px 40px rgba(13,110,253,.28)}.btn-ghost{border:1px solid rgba(15,23,42,.1);background:#fff;color:#27364d;border-radius:999px;padding:.72rem 1.05rem;font-weight:650;box-shadow:0 8px 24px rgba(15,23,42,.035)}.btn-ghost:hover{border-color:rgba(13,110,253,.28);color:var(--cms-brand)}
    .section{padding:96px 0;position:relative}.section-title{max-width:740px;margin:0 auto 2.75rem;text-align:center}.section-title h2{font-size:clamp(2rem,4vw,3rem);font-weight:760;line-height:1.08;margin:.35rem 0}.section-title p{color:var(--cms-muted);font-size:1.05rem;margin:0}.section-title,.cms-card,.hero-card,.contact-box,.cta{animation:cmsFadeUp .65s ease both}@keyframes cmsFadeUp{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:none}}@media(prefers-reduced-motion:reduce){*{animation:none!important;transition:none!important;scroll-behavior:auto!important}}
    .hero{min-height:88vh;display:flex;align-items:center;position:relative;overflow:hidden;background:radial-gradient(circle at 12% 8%,rgba(13,110,253,.16),transparent 35%),radial-gradient(circle at 88% 18%,rgba(102,16,242,.15),transparent 34%),linear-gradient(180deg,#f8fbff,#fff)}.hero:before{content:"";position:absolute;inset:auto -12% -18% -12%;height:36%;background:linear-gradient(90deg,rgba(13,110,253,.06),rgba(102,16,242,.07));filter:blur(45px)}.hero-card{border:1px solid rgba(15,23,42,.08);background:rgba(255,255,255,.78);box-shadow:0 28px 78px rgba(15,23,42,.12);border-radius:calc(var(--cms-radius) + 12px);overflow:hidden}.hero h1,.hero .h1{font-size:clamp(2.55rem,6.5vw,5rem);font-weight:780;letter-spacing:-.055em;line-height:.98}.hero p{font-size:1.12rem;color:var(--cms-muted);max-width:640px}.hero-img{min-height:410px;background-size:cover;background-position:center;background-image:linear-gradient(135deg,var(--cms-brand),var(--cms-brand2));border-radius:var(--cms-radius);box-shadow:inset 0 0 0 1px rgba(255,255,255,.28)}.hero-dots{display:flex;gap:.45rem;margin-top:1.25rem}.hero-dots button{width:10px;height:10px;border:0;border-radius:999px;background:#cbd5e1}.hero-dots button.active{background:var(--cms-brand);width:28px}
    .cms-card{height:100%;border:1px solid rgba(15,23,42,.075);border-radius:var(--cms-radius);background:rgba(255,255,255,.92);padding:1.35rem;box-shadow:0 16px 42px rgba(15,23,42,.055);transition:.22s ease}.cms-card:hover{transform:translateY(-5px);box-shadow:0 24px 70px rgba(15,23,42,.1)}.cms-icon{width:48px;height:48px;border-radius:15px;display:inline-flex;align-items:center;justify-content:center;background:rgba(13,110,253,.09);color:var(--cms-brand);font-size:1.35rem;margin-bottom:1rem}.stat-card{text-align:center;padding:1.2rem}.stat-number{font-size:clamp(2rem,4vw,3rem);font-weight:770;color:var(--cms-brand);letter-spacing:-.04em}.feature-panel{border-radius:calc(var(--cms-radius) + 10px);background:linear-gradient(135deg,rgba(13,110,253,.92),rgba(102,16,242,.92));min-height:430px;box-shadow:0 25px 70px rgba(13,110,253,.18)}.timeline-step{position:relative}.timeline-step:before{content:"";position:absolute;left:24px;top:58px;bottom:-28px;width:1px;background:rgba(13,110,253,.14)}.timeline-step:last-child:before{display:none}.pricing-card.featured{border-color:rgba(13,110,253,.28);box-shadow:0 28px 90px rgba(13,110,253,.15)}.pricing-price{font-size:2.1rem;font-weight:780;color:#172033}.faq-item{border:1px solid rgba(15,23,42,.08);border-radius:18px;background:#fff;margin-bottom:.85rem;overflow:hidden}.faq-q{width:100%;border:0;background:#fff;padding:1rem 1.1rem;text-align:left;font-weight:690;display:flex;justify-content:space-between;align-items:center}.faq-a{padding:0 1.1rem 1.1rem;color:var(--cms-muted)}
    .gallery-img{width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:var(--cms-radius);cursor:zoom-in;box-shadow:0 16px 38px rgba(15,23,42,.08)}.avatar{width:56px;height:56px;border-radius:50%;object-fit:cover;background:var(--cms-soft)}.map-frame{width:100%;min-height:380px;border:0;border-radius:var(--cms-radius);box-shadow:0 16px 42px rgba(15,23,42,.055)}.contact-box{border-radius:var(--cms-radius);background:#fff;border:1px solid rgba(15,23,42,.08);box-shadow:0 18px 45px rgba(15,23,42,.06);padding:1.5rem}.cta{border-radius:calc(var(--cms-radius) + 14px);background:linear-gradient(135deg,var(--cms-brand),var(--cms-brand2));color:#fff;padding:3rem;overflow:hidden;position:relative}.cta:after{content:"";position:absolute;right:-10%;top:-25%;width:45%;height:80%;background:rgba(255,255,255,.14);border-radius:50%;filter:blur(12px)}.cta p{color:rgba(255,255,255,.84)}.site-footer{padding:40px 0;background:#0f172a;color:#cbd5e1}.site-footer a:hover{color:#fff}.scroll-up{position:fixed;right:18px;bottom:18px;z-index:60}.admin-login{position:fixed;left:18px;bottom:18px;z-index:60}
    .cms-modal-backdrop{position:fixed;inset:0;background:rgba(15,23,42,.58);z-index:100;display:flex;align-items:center;justify-content:center;padding:1rem}.cms-modal{background:#fff;border-radius:24px;max-width:860px;width:100%;max-height:90vh;overflow:auto;box-shadow:0 30px 100px rgba(0,0,0,.25);padding:1.5rem}.cms-modal.small{max-width:480px}.cms-editable.admin{outline:1.5px dashed rgba(13,110,253,.34);outline-offset:4px;border-radius:8px;min-height:1.2em;cursor:text}.cms-editable.admin:focus{outline-color:var(--cms-brand);background:rgba(13,110,253,.055)}
    .admin-panel{position:fixed;top:0;left:0;height:100vh;width:min(540px,96vw);background:#f8fafc;z-index:110;box-shadow:26px 0 90px rgba(15,23,42,.18);transform:translateX(-110%);transition:.25s ease;overflow:auto}.admin-panel.open{transform:translateX(0)}.admin-panel header{position:sticky;top:0;background:rgba(248,250,252,.92);backdrop-filter:blur(14px);z-index:2;padding:1rem 1rem .85rem;border-bottom:1px solid rgba(15,23,42,.08)}.admin-title{font-weight:760;font-size:1.05rem}.admin-subtitle{font-size:.78rem;color:#64748b}.admin-panel .body{padding:1rem}.admin-actions{background:#fff;border:1px solid rgba(15,23,42,.07);border-radius:18px;padding:.75rem;box-shadow:0 8px 28px rgba(15,23,42,.045)}.admin-nav{display:grid;grid-template-columns:repeat(3,1fr);gap:.42rem;margin-top:.85rem}.admin-tab{border:1px solid rgba(15,23,42,.08);background:#fff;color:#41526b;padding:.58rem .65rem;border-radius:13px;font-weight:650;font-size:.84rem;text-align:left;display:flex;gap:.45rem;align-items:center;box-shadow:0 6px 18px rgba(15,23,42,.035)}.admin-tab.active{background:var(--cms-brand);border-color:var(--cms-brand);color:#fff;box-shadow:0 14px 30px rgba(13,110,253,.2)}.admin-card{background:#fff;border:1px solid rgba(15,23,42,.08);border-radius:18px;padding:1rem;margin-bottom:1rem;box-shadow:0 8px 28px rgba(15,23,42,.045)}.form-control,.form-select{border-radius:12px;border-color:rgba(15,23,42,.12)}.form-control:focus,.form-select:focus{border-color:rgba(13,110,253,.5);box-shadow:0 0 0 .2rem rgba(13,110,253,.08)}.form-control-color{width:100%}.form-label .small{color:#40516b}.editor-card{border:1px solid rgba(15,23,42,.1);border-radius:16px;background:#fff;overflow:hidden}.editor-toolbar{display:flex;gap:.35rem;flex-wrap:wrap;padding:.55rem;border-bottom:1px solid rgba(15,23,42,.08);background:#f8fafc}.editor-toolbar button{border:1px solid rgba(15,23,42,.08);background:#fff;border-radius:10px;padding:.42rem .58rem;font-weight:650}.rich-editor{min-height:170px;padding:1rem;outline:0}.rich-editor:focus{background:#fbfdff}.html-editor{border:0;border-top:1px solid rgba(15,23,42,.08);border-radius:0;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.82rem}.cookie-box{position:fixed;left:50%;bottom:16px;transform:translateX(-50%);z-index:90;background:#fff;border-radius:18px;box-shadow:0 20px 70px rgba(15,23,42,.18);border:1px solid rgba(15,23,42,.08);padding:1rem;max-width:720px;width:calc(100% - 32px)}
    .search-result{display:block;padding:.85rem;border-bottom:1px solid rgba(15,23,42,.08)}.share-row{display:flex;gap:.5rem;flex-wrap:wrap;margin-top:1rem}.share-row a{border:1px solid rgba(15,23,42,.1);border-radius:999px;padding:.5rem .8rem;font-weight:650}.load-more-wrap{text-align:center;margin-top:2rem}.product-card-img{width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:var(--cms-radius);background:linear-gradient(135deg,var(--cms-brand),var(--cms-brand2))}.product-price{font-size:1.1rem;color:var(--cms-brand);font-weight:760}.old-price{text-decoration:line-through;color:var(--cms-muted);font-size:.92rem}.discount-badge{display:inline-flex;align-items:center;border-radius:999px;padding:.25rem .55rem;background:rgba(32,201,151,.12);color:#047857;font-size:.78rem;font-weight:720}.product-actions{display:flex;gap:.55rem;flex-wrap:wrap;margin-top:1rem}.product-gallery{display:grid;grid-template-columns:repeat(4,1fr);gap:.55rem;margin:.75rem 0 1rem}.product-gallery img{width:100%;aspect-ratio:1;object-fit:cover;border-radius:14px;cursor:pointer}.basket-btn{position:fixed;right:18px;bottom:82px;z-index:60}.basket-count{display:inline-flex;min-width:22px;height:22px;align-items:center;justify-content:center;border-radius:999px;background:#fff;color:var(--cms-brand);font-size:.78rem;font-weight:800}.basket-line{display:grid;grid-template-columns:1fr auto;gap:.75rem;align-items:center;border-bottom:1px solid rgba(15,23,42,.08);padding:.75rem 0}
    @media(max-width:767px){.section{padding:72px 0}.hero{min-height:auto;padding-top:70px}.admin-nav{grid-template-columns:repeat(2,1fr)}.hero-img{min-height:280px}}
    <?= $theme['customCss'] ?? '' ?>
  </style>
  <?php
    $ld = [
    ...
    if (($meta['type'] ?? '') === 'article' && !empty($meta['item'])) {
      ...
      $productPrice = $meta['item']['price'] ?? 0;
      $productCurrency = $meta['item']['currency'] ?? ($data['products']['currency'] ?? 'EUR');
      $ld = ['@context'=>'https://schema.org','@type'=>'Product','name'=>$meta['item']['title'] ?? $meta['title'],'description'=>$meta['description'] ?? '','sku'=>$meta['item']['sku'] ?? null,'image'=>$metaImage ?: null,'offers'=>['@type'=>'Offer','price'=>(string)$productPrice,'priceCurrency'=>$productCurrency,'availability'=>'https://schema.org/InStock']];
    }
  ?>
...
<body>
  ...
  (() => {
    ...
    function App(){
      ...
      const [quoteItems,setQuoteItems] = useState(()=>{ try{return JSON.parse(localStorage.getItem('cms_quote_items')||'[]')}catch(e){return[]} });
      ...
      useEffect(()=>{ localStorage.setItem('cms_quote_items', JSON.stringify(quoteItems)); }, [quoteItems]);

      function productPriceValue(item){ if(typeof item.price==='number') return item.price; const m=String(item.price||'').replace(',','.').match(/[0-9]+(?:\.[0-9]+)?/); return m ? Number(m[0]) : 0; }
      function formatProductPrice(item){ const currency=item.currency || data.products?.currency || 'EUR'; const price=productPriceValue(item); return price>0 ? new Intl.NumberFormat(undefined,{style:'currency',currency}).format(price) : 'Price on request'; }
      function quoteLine(item){ const sku=item.sku ? ` [${item.sku}]` : ''; return `${item.title||'Product'}${sku} - ${formatProductPrice(item)}`; }
      function addToQuote(item){ setQuoteItems(items=>{ const key=item.slug||item.title||String(Date.now()); if(items.some(x=>(x.slug||x.title)===key)) return items; return [...items,{title:item.title||'Product',slug:item.slug||'',sku:item.sku||'',price:item.price||0,currency:item.currency||data.products?.currency||'EUR'}]; }); setNotice('Added to quote basket'); }
      function removeQuote(i){ setQuoteItems(items=>items.filter((_,x)=>x!==i)); }
      function clearQuote(){ setQuoteItems([]); }
      function quoteMessage(){ return quoteItems.length ? 'Quote request products:\n' + quoteItems.map((it,i)=>`${i+1}. ${quoteLine(it)}`).join('\n') + '\n\nMessage:' : ''; }
      ...
      const api = {data,setData,update,replace,Editable,admin,email:boot.email,setModal,lang,setLang,save,logout,dirty,notice,setNotice,adminOpen,setAdminOpen,csrf,boot,setBoot,quoteItems,addToQuote,removeQuote,clearQuote,quoteMessage,formatProductPrice,productPriceValue};
      return h(React.Fragment,null,
        h(Header,{api}),
        boot.route?.item && h(RoutePage,{api,route:boot.route}),
        data.hero?.enabled && h(Hero,{api}),
        data.about?.enabled && h(About,{api}),
        data.stats?.enabled && h(Stats,{api}),
        data.features?.enabled && h(FeatureBlocks,{api}),
        data.services?.enabled && h(Services,{api}),
        data.process?.enabled && h(Process,{api}),
        data.gallery?.enabled && h(Gallery,{api}),
        data.testimonials?.enabled && h(Testimonials,{api}),
        data.products?.enabled && h(Products,{api}),
        data.pricing?.enabled && h(Pricing,{api}),
        data.blog?.enabled && h(Blog,{api}),
        data.faq?.enabled && h(FAQ,{api}),
        ...
        !admin && h(LoginButton),
        data.products?.basketEnabled && quoteItems.length>0 && h('button',{className:'btn-cms basket-btn',onClick:()=>setModal({type:'basket'})}, icon('bi bi-bag'), ' Quote ', h('span',{className:'basket-count'},quoteItems.length)),
    ...
    function RoutePage({api,route}){ const item=route.item||{}; const group=route.group||'pages'; const path=`${group}.items.${route.index}`; const E=api.Editable; const isProduct=group==='products'; const price=api.productPriceValue(item); const showBuy=isProduct && api.data.products?.showBuyButton && item.buyButton!==false && price>0; const showQuote=isProduct && api.data.products?.showQuoteButton && item.quoteButton!==false; return h('section',{className:'section cms-soft'}, h(Container,{api}, h('article',{className:'cms-card mx-auto',style:{maxWidth:980}}, h('div',{className:'eyebrow text-primary fw-bold mb-2'}, isProduct?'Product':group==='blog'?'Blog':'Page'), item.image&&h('img',{src:item.image,alt:item.title,className:'img-fluid rounded-4 mb-4'}), h(E,{path:path+'.title',tag:'h1',className:'display-5 fw-bold'}), item.date&&h('p',{className:'muted'},item.date), isProduct&&h(ProductPrice,{api,item,path}), h(E,{path:path+'.body',tag:'div',html:true,className:'fs-5'}), isProduct&&Array.isArray(item.features)&&item.features.length>0&&h('ul',{className:'mt-3'},item.features.map((f,i)=>h('li',{key:i}, h(E,{path:path+'.features.'+i})))), isProduct&&h('div',{className:'product-actions'}, showBuy&&h('a',{className:'btn-cms',href:item.buyUrl||'#contact'},api.data.products?.buyButtonText||'Buy'), showQuote&&h('button',{className:'btn-ghost',onClick:()=>api.addToQuote(item)},api.data.products?.quoteButtonText||'Add to quote')), h('div',{className:'share-row'}, shareLinks(location.href,item.title).map(s=>h('a',{key:s.label,href:s.url,target:'_blank',rel:'noopener'},s.label)))))); }
    ...
    function About({api}){ const d=api.data.about, E=api.Editable; return h('section',{id:'about',className:'section'}, h(Container,{api}, h('div',{className:'row align-items-center g-5'}, h('div',{className:'col-lg-6'}, d.image?h('img',{className:'img-fluid rounded-4 shadow-sm',src:d.image,alt:d.title}):h('div',{className:'feature-panel'})), h('div',{className:'col-lg-6'}, h('div',{className:'eyebrow mb-2'},'About'), h(E,{path:'about.title',tag:'h2',className:'display-5'}), h(E,{path:'about.subtitle',tag:'p',className:'lead muted'}), h(E,{path:'about.body',tag:'div',html:true,className:'fs-5'}))))); }

    function Stats({api}){ const E=api.Editable; const items=api.data.stats?.items||[]; return h('section',{id:'stats',className:'section pt-0'}, h(Container,{api}, h(SectionTitle,{api,base:'stats'}), h('div',{className:'row g-4'}, items.map((it,i)=>h('div',{className:'col-6 col-lg-3',key:i}, h('div',{className:'cms-card stat-card'}, h(E,{path:`stats.items.${i}.number`,tag:'div',className:'stat-number'}), h(E,{path:`stats.items.${i}.label`,tag:'p',className:'muted mb-0'}))))))); }

    function FeatureBlocks({api}){ const E=api.Editable; const d=api.data.features||{}; return h('section',{id:'features',className:'section cms-soft'}, h(Container,{api}, h('div',{className:'row g-5 align-items-center'}, h('div',{className:'col-lg-5'}, h('div',{className:'eyebrow mb-2'},'Features'), h(E,{path:'features.title',tag:'h2',className:'display-5'}), h(E,{path:'features.subtitle',tag:'p',className:'lead muted mb-4'}), h('div',{className:'row g-3'}, (d.items||[]).map((it,i)=>h('div',{className:'col-12',key:i}, h('article',{className:'cms-card d-flex gap-3'}, h('div',{className:'cms-icon flex-shrink-0'},icon(it.icon,'bi bi-check2-circle')), h('div',null, h(E,{path:`features.items.${i}.title`,tag:'h3',className:'h5'}), h(E,{path:`features.items.${i}.text`,tag:'p',className:'muted mb-0'}))))))), h('div',{className:'col-lg-7'}, d.image?h('img',{src:d.image,alt:d.title,className:'img-fluid rounded-4 shadow-sm'}):h('div',{className:'feature-panel'}))))); }

    function Process({api}){ const E=api.Editable; return h('section',{id:'process',className:'section'}, h(Container,{api}, h(SectionTitle,{api,base:'process'}), h('div',{className:'row justify-content-center'}, h('div',{className:'col-lg-8'}, (api.data.process?.items||[]).map((it,i)=>h('article',{className:'timeline-step d-flex gap-3 mb-4',key:i}, h('div',{className:'cms-icon flex-shrink-0'},icon(it.icon,'bi bi-check')), h('div',{className:'cms-card flex-fill'}, h('div',{className:'small muted mb-1'},'0'+(i+1)), h(E,{path:`process.items.${i}.title`,tag:'h3',className:'h4'}), h(E,{path:`process.items.${i}.text`,tag:'p',className:'muted mb-0'})))))))); }

    function Pricing({api}){ const E=api.Editable; return h('section',{id:'pricing',className:'section cms-soft'}, h(Container,{api}, h(SectionTitle,{api,base:'pricing'}), h('div',{className:'row g-4'}, (api.data.pricing?.items||[]).map((it,i)=>h('div',{className:'col-md-6 col-lg-4',key:i}, h('article',{className:cls('cms-card pricing-card',i===1&&'featured')}, h(E,{path:`pricing.items.${i}.title`,tag:'h3',className:'h4'}), h('div',{className:'d-flex align-items-end gap-2 my-3'}, h(E,{path:`pricing.items.${i}.price`,tag:'div',className:'pricing-price'}), h(E,{path:`pricing.items.${i}.period`,tag:'div',className:'muted mb-2'})), h(E,{path:`pricing.items.${i}.text`,tag:'p',className:'muted'}), Array.isArray(it.features)&&h('ul',{className:'list-unstyled'},it.features.map((f,j)=>h('li',{key:j,className:'mb-2'},icon('bi bi-check2 text-primary me-2'),h(E,{path:`pricing.items.${i}.features.${j}`})))), h('a',{className:'btn-ghost mt-2',href:it.buttonHref||'#contact'}, h(E,{path:`pricing.items.${i}.buttonText`})))))))); }

    function FAQ({api}){ const E=api.Editable; const [open,setOpen]=useState(0); return h('section',{id:'faq',className:'section'}, h(Container,{api}, h(SectionTitle,{api,base:'faq'}), h('div',{className:'mx-auto',style:{maxWidth:860}}, (api.data.faq?.items||[]).map((it,i)=>h('div',{className:'faq-item',key:i}, h('button',{className:'faq-q',onClick:()=>setOpen(open===i?null:i)}, h(E,{path:`faq.items.${i}.question`}), h('span',null,open===i?'−':'+')), open===i&&h('div',{className:'faq-a'}, h(E,{path:`faq.items.${i}.answer`,tag:'div',html:true}))))))); }

    function LoadMoreGrid({api,base,render,columns}){ const section=api.data[base]||{}; const startCount=section.homeLimit||section.batch||3; const addCount=section.batch||startCount; const items=section.items||[]; useEffect(()=>{},[base]); const [count,setCount]=useState(startCount); useEffect(()=>setCount(startCount),[base,startCount]); return h(React.Fragment,null, h('div',{className:'row g-4'}, items.slice(0,count).map((item,i)=>render(item,i,columns))), section.showButton && count<items.length && h('div',{className:'load-more-wrap'}, h('button',{className:'btn-cms',onClick:()=>setCount(c=>c+addCount)}, section.buttonText||'Load more'))); }
    ...
    function Testimonials({api}){ const E=api.Editable; return h('section',{id:'testimonials',className:'section cms-soft'}, h(Container,{api}, h(SectionTitle,{api,base:'testimonials'}), h(LoadMoreGrid,{api,base:'testimonials',render:(it,i)=>h('div',{className:'col-md-6 col-lg-4',key:i}, h('article',{className:'cms-card'}, h('div',{className:'d-flex align-items-center gap-3 mb-3'}, it.photo?h('img',{src:it.photo,alt:it.name,className:'avatar'}):h('div',{className:'avatar'}), h('div',null,h(E,{path:`testimonials.items.${i}.name`,tag:'strong'}), h(E,{path:`testimonials.items.${i}.role`,tag:'div',className:'small muted'}))), h(E,{path:`testimonials.items.${i}.text`,tag:'p',className:'mb-0'}))) }))); }

    function ProductPrice({api,item,path}){ const price=api.productPriceValue(item); return h('div',{className:'d-flex align-items-center gap-2 flex-wrap mb-3'}, h('span',{className:'product-price'}, price>0 ? api.formatProductPrice(item) : 'Price on request'), Number(item.oldPrice||0)>price&&price>0&&h('span',{className:'old-price'}, new Intl.NumberFormat(undefined,{style:'currency',currency:item.currency||api.data.products?.currency||'EUR'}).format(Number(item.oldPrice))), item.discountLabel&&h('span',{className:'discount-badge'},item.discountLabel)); }
    function ProductButtons({api,item}){ const price=api.productPriceValue(item); const cfg=api.data.products||{}; const showBuy=cfg.showBuyButton && item.buyButton!==false && price>0; const showQuote=cfg.showQuoteButton && item.quoteButton!==false; return h('div',{className:'product-actions'}, showBuy&&h('a',{className:'btn-cms',href:item.buyUrl||'#contact'},cfg.buyButtonText||'Buy'), showQuote&&h('button',{className:showBuy?'btn-ghost':'btn-cms',onClick:()=>api.addToQuote(item)},cfg.quoteButtonText||'Add to quote')); }
    function ProductCard({api,it,i}){ const E=api.Editable; const img=it.image||it.gallery?.[0]||''; return h('div',{className:'col-sm-6 col-lg-3',key:i}, h('article',{className:'cms-card'}, img?h('img',{src:img,alt:it.title,className:'product-card-img mb-3'}):h('div',{className:'product-card-img mb-3'}), it.discountLabel&&h('span',{className:'discount-badge mb-2'},it.discountLabel), h(E,{path:`products.items.${i}.title`,tag:'h3',className:'h5 fw-bold'}), h(ProductPrice,{api,item:it,path:`products.items.${i}`}), h(E,{path:`products.items.${i}.text`,tag:'p',className:'muted'}), h('div',{className:'product-actions'}, h('a',{className:'btn-ghost',href:pretty('products',it),onClick:e=>{ if(!e.metaKey&&!e.ctrlKey){ e.preventDefault(); api.setModal({type:'item',group:'products',index:i}); }}},'Details')), h(ProductButtons,{api,item:it}))); }
    function Products({api}){ return h('section',{id:'products',className:'section'}, h(Container,{api}, h(SectionTitle,{api,base:'products'}), h(LoadMoreGrid,{api,base:'products',render:(it,i)=>h(ProductCard,{api,it,i})}))); }
    ...
    function CTA({api}){ const E=api.Editable; return h('section',{className:'section'}, h(Container,{api}, h('div',{className:'cta text-center'}, h(E,{path:'cta.title',tag:'h2',className:'display-6 fw-bold'}), h(E,{path:'cta.text',tag:'div',html:true,className:'lead'}), h('button',{className:'btn-ghost',onClick:()=>api.setModal({type:'form'})}, h(E,{path:'cta.buttonText'}))))); }
    ...
    function Modal({modal,setModal,api}){ if(modal.type==='search') return h(SearchModal,{api,onClose:()=>setModal(null)}); if(modal.type==='form') return h(FormModal,{api,modal,onClose:()=>setModal(null)}); if(modal.type==='basket') return h(BasketModal,{api,onClose:()=>setModal(null)}); if(modal.type==='item') return h(ItemModal,{api,modal,onClose:()=>setModal(null)}); return null; }
    function SearchModal({api,onClose}){ const [q,setQ]=useState(''); const results=useMemo(()=>{ if(!q.trim()) return []; const low=q.toLowerCase(); const out=[]; ['services','features','process','pricing','faq','products','blog','gallery','pages'].forEach(group=>(api.data[group]?.items||[]).forEach((it,i)=>{ if(JSON.stringify(it).toLowerCase().includes(low)) out.push({group,i,title:it.title||it.alt||group,text:it.excerpt||it.text||it.alt||'',href:['blog','products','pages'].includes(group)?pretty(group,it):'#'+group}); })); return out.slice(0,20); },[q,api.data]); return h('div',{className:'cms-modal-backdrop',onClick:onClose}, h('div',{className:'cms-modal',onClick:e=>e.stopPropagation()}, h('div',{className:'d-flex justify-content-between align-items-center mb-3'}, h('h3',null,'Ajax search'), h('button',{className:'icon-btn',onClick:onClose},icon('bi bi-x-lg'))), h('input',{autoFocus:true,className:'form-control form-control-lg',placeholder:'Search this page...',value:q,onChange:e=>setQ(e.target.value)}), h('div',{className:'mt-3'}, results.map((r,i)=>h('a',{key:i,className:'search-result',href:r.href,onClick:onClose}, h('strong',null,r.title), h('span',{className:'badge text-bg-light ms-2'},r.group), h('p',{className:'muted mb-0'},r.text)))))); }

    function ItemModal({api,modal,onClose}){ const item=api.data[modal.group]?.items?.[modal.index]||{}; const path=`${modal.group}.items.${modal.index}`; const E=api.Editable; const url=absolute(pretty(modal.group,item)); const isProduct=modal.group==='products'; const imgs=[item.image,...(item.gallery||[])].filter(Boolean); const [active,setActive]=useState(imgs[0]||''); return h('div',{className:'cms-modal-backdrop',onClick:onClose}, h('article',{className:'cms-modal',onClick:e=>e.stopPropagation()}, h('button',{className:'icon-btn float-end',onClick:onClose},icon('bi bi-x-lg')), active&&h('img',{src:active,alt:item.title,className:'img-fluid rounded-4 mb-3'}), isProduct&&imgs.length>1&&h('div',{className:'product-gallery'},imgs.map((src,i)=>h('img',{key:i,src,alt:item.title,onClick:()=>setActive(src)}))), h(E,{path:path+'.title',tag:'h2',className:'fw-bold'}), item.date&&h('p',{className:'muted'},item.date), isProduct?h(ProductPrice,{api,item,path}):(item.price&&h(E,{path:path+'.price',tag:'strong',className:'text-primary d-block mb-3'})), item.sku&&h('p',{className:'small muted mb-2'},'SKU: ',item.sku), h(E,{path:path+'.body',tag:'div',html:true,className:'fs-5'}), isProduct&&Array.isArray(item.features)&&item.features.length>0&&h('ul',{className:'mt-3'},item.features.map((f,i)=>h('li',{key:i}, h(E,{path:path+'.features.'+i})))), isProduct&&h(ProductButtons,{api,item}), h('div',{className:'share-row'}, shareLinks(url,item.title).map(s=>h('a',{key:s.label,href:s.url,target:'_blank',rel:'noopener'},s.label))))); }

    function BasketModal({api,onClose}){ const cfg=api.data.products||{}; return h('div',{className:'cms-modal-backdrop',onClick:onClose}, h('div',{className:'cms-modal small',onClick:e=>e.stopPropagation()}, h('div',{className:'d-flex justify-content-between align-items-center mb-3'}, h('h3',null,cfg.basketTitle||'Quote basket'), h('button',{className:'icon-btn',onClick:onClose},icon('bi bi-x-lg'))), api.quoteItems.length===0?h('p',{className:'muted'},'Quote basket is empty.') : h(React.Fragment,null, api.quoteItems.map((it,i)=>h('div',{className:'basket-line',key:i}, h('div',null,h('strong',null,it.title), h('div',{className:'small muted'}, api.formatProductPrice(it), it.sku?` · ${it.sku}`:'')), h('button',{className:'icon-btn',onClick:()=>api.removeQuote(i)},icon('bi bi-trash')))), h('div',{className:'d-flex gap-2 mt-3'}, h('button',{className:'btn-cms flex-fill',onClick:()=>api.setModal({type:'form',formType:'quote',message:api.quoteMessage()})},cfg.basketButtonText||'Send quote request'), h('button',{className:'btn-ghost',onClick:api.clearQuote},'Clear'))))); }
    ...
    function AdminPanel({api,open,onClose}){ const [tab,setTab]=useState('site'); if(!api.admin) return null; const tabs=[['site','bi bi-house','Site'],['theme','bi bi-palette','Theme'],['menu','bi bi-list-ul','Menu'],['content','bi bi-layout-text-window','Content'],['products','bi bi-bag','Products'],['blog','bi bi-journal-text','Blog'],['media','bi bi-images','Media'],['seo','bi bi-search','SEO'],['forms','bi bi-envelope','Forms'],['libraries','bi bi-plugin','Libraries'],['redirects','bi bi-signpost','Redirects'],['server','bi bi-hdd-network','Server'],['json','bi bi-braces','JSON']]; return h('aside',{className:cls('admin-panel',open&&'open')}, h('header',null, h('div',{className:'d-flex justify-content-between align-items-center'}, h('div',null,h('div',{className:'admin-title'},'LPCMS Admin'), h('div',{className:'admin-subtitle'},api.email || 'Inline editor')), h('button',{className:'icon-btn',onClick:onClose},icon('bi bi-x-lg'))), h('div',{className:'admin-nav'}, tabs.map(([key,ic,label])=>h('button',{key,className:cls('admin-tab',tab===key&&'active'),onClick:()=>setTab(key)},icon(ic), h('span',null,label))))), h('div',{className:'body'}, h('div',{className:'admin-actions mb-3'}, api.dirty&&h('div',{className:'alert alert-warning py-2 mb-2'},'Unsaved changes'), h('div',{className:'d-flex gap-2'}, h('button',{className:'btn-cms flex-fill',onClick:api.save},icon('bi bi-save'),' Save JSON'), h('button',{className:'btn-ghost',onClick:api.logout},'Logout'))), tab==='site'&&h(SiteTab,{api}), tab==='theme'&&h(ThemeTab,{api}), tab==='menu'&&h(MenuTab,{api}), tab==='content'&&h(ContentTab,{api}), tab==='products'&&h(ProductsTab,{api}), tab==='blog'&&h(BlogTab,{api}), tab==='media'&&h(MediaTab,{api}), tab==='seo'&&h(SeoTab,{api}), tab==='forms'&&h(FormsTab,{api}), tab==='libraries'&&h(LibrariesTab,{api}), tab==='redirects'&&h(RedirectsTab,{api}), tab==='server'&&h(ServerTab,{api}), tab==='json'&&h(JsonTab,{api}) )); }
    ...
    function RichText({api,path,label}){ const start=get(api.data,path)||''; const [html,setHtml]=useState(start); const ref=useRef(null); useEffect(()=>{ const v=get(api.data,path)||''; setHtml(v); if(ref.current && ref.current.innerHTML!==v) ref.current.innerHTML=v; },[path,get(api.data,path)]); function save(){ if(ref.current) api.update(path,ref.current.innerHTML); } function cmd(name,arg){ if(ref.current) ref.current.focus(); document.execCommand(name,false,arg||null); save(); } function link(){ const url=prompt('Link URL','https://'); if(url) cmd('createLink',url); } const buttons=[['bold','B'],['italic','I'],['underline','U'],['insertUnorderedList','• List'],['insertOrderedList','1. List']]; return h(Field,{label}, h('div',{className:'editor-card'}, h('div',{className:'editor-toolbar'}, buttons.map(([c,t])=>h('button',{type:'button',key:c,onClick:()=>cmd(c)},t)), h('button',{type:'button',onClick:()=>cmd('formatBlock','<h2>')},'H2'), h('button',{type:'button',onClick:()=>cmd('formatBlock','<h3>')},'H3'), h('button',{type:'button',onClick:link},'Link'), h('button',{type:'button',onClick:()=>cmd('removeFormat')},'Clear')), h('div',{ref,className:'rich-editor',contentEditable:true,suppressContentEditableWarning:true,onBlur:save,dangerouslySetInnerHTML:{__html:html}}), h('textarea',{className:'form-control html-editor',rows:4,value:html,onChange:e=>{setHtml(e.target.value);api.update(path,e.target.value)}},null))); }
    ...
    function ContentTab({api}){ const secs=['hero','about','stats','features','services','process','gallery','testimonials','products','pricing','blog','faq','contact','cta']; return h(React.Fragment,null, h('div',{className:'admin-card'}, h('h5',null,'Section visibility'), secs.map(s=>h(Bool,{key:s,api,path:s+'.enabled',label:'Show '+s}))), h('div',{className:'admin-card'}, h('h5',null,'Visual text editor'), h(RichText,{api,path:'about.body',label:'About body'}), h(RichText,{api,path:'cta.text',label:'CTA text / HTML'}), h('p',{className:'small muted mb-0'},'Headings and card text are still editable directly on the public page. Rich text fields support bold, italic, lists, headings, links, and HTML editing.'))); }

    function ProductsTab({api}){ const arr=api.data.products?.items||[]; const cfg=api.data.products||{}; function upd(i,k,v){ const next=[...arr]; next[i]={...next[i],[k]:v}; api.update('products.items',next); } function add(){ api.update('products.items',[...arr,{title:'New product',slug:'new-product',sku:'',price:0,oldPrice:0,discountLabel:'',currency:cfg.currency||'EUR',image:'',gallery:[],text:'Short product text.',body:'<p>Product description.</p>',features:[],buyUrl:'',buyButton:false,quoteButton:true,seo:{title:'New product',description:'',image:''}}]); }
      return h(React.Fragment,null, h('div',{className:'alert alert-info'},'Products can run like blog posts with SEO URLs, modal windows, gallery, prices, discounts, buy buttons, and quote basket.'), h(Bool,{api,path:'products.enabled',label:'Enable products section'}), h(Txt,{api,path:'products.homeLimit',label:'Homepage initial products',type:'number'}), h(Txt,{api,path:'products.batch',label:'Load-more amount',type:'number'}), h(Bool,{api,path:'products.showButton',label:'Show load more button'}), h(Bool,{api,path:'products.showBuyButton',label:'Enable Buy buttons'}), h(Bool,{api,path:'products.showQuoteButton',label:'Enable Add to quote buttons'}), h(Bool,{api,path:'products.basketEnabled',label:'Enable quote basket'}), h(Txt,{api,path:'products.buyButtonText',label:'Buy button text'}), h(Txt,{api,path:'products.quoteButtonText',label:'Quote button text'}), h(Txt,{api,path:'products.currency',label:'Default currency'}), h('hr'), arr.map((it,i)=>h('div',{key:i,className:'border rounded-4 p-3 mb-3'}, h('div',{className:'d-flex justify-content-between gap-2'}, h('strong',null,it.title||'Product'), h('button',{className:'btn-ghost',onClick:()=>api.update('products.items',arr.filter((_,x)=>x!==i))},'Remove')), h('input',{className:'form-control my-2',value:it.title||'',onChange:e=>upd(i,'title',e.target.value),placeholder:'Product title'}), h('input',{className:'form-control mb-2',value:it.slug||'',onChange:e=>upd(i,'slug',e.target.value),placeholder:'slug'}), h('div',{className:'row g-2'}, h('div',{className:'col-6'},h('input',{className:'form-control mb-2',type:'number',value:it.price||0,onChange:e=>upd(i,'price',Number(e.target.value||0)),placeholder:'Price'})), h('div',{className:'col-6'},h('input',{className:'form-control mb-2',type:'number',value:it.oldPrice||0,onChange:e=>upd(i,'oldPrice',Number(e.target.value||0)),placeholder:'Old price'}))), h('input',{className:'form-control mb-2',value:it.discountLabel||'',onChange:e=>upd(i,'discountLabel',e.target.value),placeholder:'Discount label, e.g. -20%'}), h('input',{className:'form-control mb-2',value:it.image||'',onChange:e=>upd(i,'image',e.target.value),placeholder:'Main image URL'}), h('input',{className:'form-control mb-2',value:it.buyUrl||'',onChange:e=>upd(i,'buyUrl',e.target.value),placeholder:'Buy URL'}), h('textarea',{className:'form-control mb-2',rows:2,value:it.text||'',onChange:e=>upd(i,'text',e.target.value),placeholder:'Card text'}), h(RichText,{api,path:`products.items.${i}.body`,label:'Visual product description'}), h(Field,{label:'Gallery JSON array'}, h('textarea',{className:'form-control',rows:2,value:JSON.stringify(it.gallery||[],null,2),onChange:e=>{try{upd(i,'gallery',JSON.parse(e.target.value))}catch(err){}}})), h('div',{className:'row'}, h('div',{className:'col-6'},h(Bool,{api,path:`products.items.${i}.buyButton`,label:'Buy button'})), h('div',{className:'col-6'},h(Bool,{api,path:`products.items.${i}.quoteButton`,label:'Quote button'}))), h('p',{className:'small muted'},'Use price 0 to hide Buy and show quote-only flow. Edit full description/body and SEO in JSON or inline modal.'))), h('button',{className:'btn-cms',onClick:add},'Add product')); }

    function BlogTab({api}){ const arr=api.data.blog?.items||[]; function upd(i,k,v){ const next=[...arr]; next[i]={...next[i],[k]:v}; api.update('blog.items',next); } function add(){ api.update('blog.items',[...arr,{title:'New post',slug:'new-post',date:new Date().toISOString().slice(0,10),image:'',excerpt:'Short post excerpt.',body:'<p>Write the post content here.</p>',seo:{title:'New post',description:'',image:''}}]); } return h(React.Fragment,null, h('div',{className:'admin-card'}, h(Bool,{api,path:'blog.enabled',label:'Enable blog section'}), h(Txt,{api,path:'blog.batch',label:'Load-more amount',type:'number'}), h(Bool,{api,path:'blog.showButton',label:'Show load more button'})), arr.map((it,i)=>h('div',{key:i,className:'admin-card'}, h('div',{className:'d-flex justify-content-between gap-2 mb-2'}, h('strong',null,it.title||'Post'), h('button',{className:'btn-ghost',onClick:()=>api.update('blog.items',arr.filter((_,x)=>x!==i))},'Remove')), h('input',{className:'form-control mb-2',value:it.title||'',onChange:e=>upd(i,'title',e.target.value),placeholder:'Post title'}), h('input',{className:'form-control mb-2',value:it.slug||'',onChange:e=>upd(i,'slug',e.target.value),placeholder:'slug'}), h('input',{className:'form-control mb-2',value:it.date||'',onChange:e=>upd(i,'date',e.target.value),placeholder:'YYYY-MM-DD'}), h('input',{className:'form-control mb-2',value:it.image||'',onChange:e=>upd(i,'image',e.target.value),placeholder:'Image URL'}), h('textarea',{className:'form-control mb-2',rows:2,value:it.excerpt||'',onChange:e=>upd(i,'excerpt',e.target.value),placeholder:'Excerpt'}), h(RichText,{api,path:`blog.items.${i}.body`,label:'Visual post body'}), h('div',{className:'row g-2'}, h('div',{className:'col-12'},h('input',{className:'form-control mb-2',value:it.seo?.title||'',onChange:e=>{const next=[...arr]; next[i]={...next[i],seo:{...(next[i].seo||{}),title:e.target.value}}; api.update('blog.items',next);},placeholder:'SEO title'})), h('div',{className:'col-12'},h('textarea',{className:'form-control',rows:2,value:it.seo?.description||'',onChange:e=>{const next=[...arr]; next[i]={...next[i],seo:{...(next[i].seo||{}),description:e.target.value}}; api.update('blog.items',next);},placeholder:'SEO description'}))))), h('button',{className:'btn-cms',onClick:add},'Add blog post')); }
