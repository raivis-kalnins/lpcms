...
<body>
  ...
  (() => {
    ...
    function App(){
      ...
      const api = {data,setData,update,replace,Editable,admin,setModal,lang,setLang,save,logout,dirty,notice,setNotice,adminOpen,setAdminOpen,csrf,boot,setBoot,quoteItems,addToQuote,removeQuote,clearQuote,quoteMessage,formatProductPrice,productPriceValue};
